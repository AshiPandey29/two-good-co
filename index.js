...
function loadingAnimation(){
    ...
    gsap.from("#page3 #container #product1",{
        y:100,
        opacity:0,
        delay:3,
        duration:0.7,
    ...
    gsap.from("#page3 #container #product2",{
        y:100,
        opacity:0,
        delay:3.5,
        duration:0.7,
    ...
    gsap.from("#page3 #container #product3",{
        y:100,
        opacity:0,
        delay:4,
        duration:0.7,
    ...
    gsap.from("#page3 #container #product4",{
        y:100,
        opacity:0,
        delay:4.5,
        duration:0.7,
